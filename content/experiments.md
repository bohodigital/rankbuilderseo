  ...
  "experiments": [
    {
      ...
      "baseline": "Not yet captured. Packet 3 owns the Search Console impression and query-mix baseline.",
      "measurementWindow": "28 days",
      "status": "Queued",
      "measurement": "Impressions + query mix",
      "cohort": "Selected published article pages using direct descriptive titles",
      "intervention": "Hold article copy stable while observing the direct title pattern",
      "result": "Not started; Search Console baseline and query evidence remain unavailable.",
    ...
    },
    {
      ...
      "cohort": "The twelve established glossary terms with canonical detail pages",
      "intervention": "Publish definition-first canonical term pages while preserving index anchors",
      "baselineCapturedAt": "2026-07-17",
      ...
      "provenance": ["WO-2026-07-17-RANKBUILDERSEO-COMPREHENSIVE-LIVE-AUDIT-001 documented twelve fragment-addressed glossary entries and no standalone detail routes.","WO-2026-07-18-RANKBUILDERSEO-POST-ALIGNMENT-LIVE-AUDIT-001 verified twelve canonical glossary detail routes plus preserved index anchors on the deployed feature state."],
    ...
    },
    {
      ...
      "cohort": "The twelve protected publication pages",
      "intervention": "Expose validated evidence labels, citations, and claim limits without changing protected primary copy",
      "baselineCapturedAt": "2026-07-17",
      "startedAt": "2026-07-18",
      "result": "Pending; the measurement window is still open.",
      ...
      "provenance": ["WO-2026-07-17-RANKBUILDERSEO-COMPREHENSIVE-LIVE-AUDIT-001 documented article evidence labels without inspectable citations or record-level correction history.","WO-2026-07-18-RANKBUILDERSEO-POST-ALIGNMENT-LIVE-AUDIT-001 verified inspectable primary-source citations and visible correction sections on the deployed feature state."],
